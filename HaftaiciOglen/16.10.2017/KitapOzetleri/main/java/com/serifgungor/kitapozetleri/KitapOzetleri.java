...
public class KitapOzetleri {
    ...
    public KitapOzetleri(int sayfaSayisi, int puan, String kitapAdi, String yazarAdSoyad, String yayinEvi, String resim, String tur, String ozet, String dil, String basimTarihi) {
