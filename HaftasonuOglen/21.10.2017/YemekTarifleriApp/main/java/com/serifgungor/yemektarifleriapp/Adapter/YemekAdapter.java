...
public class YemekAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        TextView tvBaslik = (TextView)view.findViewById(R.id.tvYemekIsim);
        TextView tvHazirlamaSuresi = (TextView)view.findViewById(R.id.txtHazirlamaSuresi);
        TextView tvPisirmeSuresi = (TextView)view.findViewById(R.id.txtPisirmeSuresi);
        TextView tvKisiSayisi = (TextView)view.findViewById(R.id.txtKisiSayisi);
        ImageView ivYemekResim = (ImageView)view.findViewById(R.id.ivYemekResim);
